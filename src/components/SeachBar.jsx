...
function SearchBar(){
    ...
    return showSearch && visible ? (
        <div className="border-t p-5 border-b text-center bg-gray-50">
            <div className="inline-flex items-center justify-center border border-r-gray-500 px-5 py-2 mx-3 rounded-full w-3/4 sm:w-1/2">
